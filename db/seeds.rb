...
Location.create(:name => 'The Hampton', :address1 => '57 Upper North Street', :phone => '01273 731347', :postcode => 'BN1 3FH', :city_id => brighton.id, :user_id => u_admin.id)
Location.create(:name => 'The Windmill', :address1 => '69 Upper North Street', :phone => '01273 202475', :postcode => 'BN1 3FL', :city_id => brighton.id, :user_id => u_admin.id)
Location.create(:name => 'The Swan Inn', :address1 => 'Middle Street', :phone => '01273 681842', :postcode => 'BN1 9PD', :city_id => falmer.id, :user_id => u_admin.id)
